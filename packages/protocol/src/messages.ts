...
export type ConnectionStatus = MobileConnectionStatus;
...
export type ApplicationRemoteMessage =
  | MoveMouseMessage
  | LeftClickMessage
  | DoubleClickMessage
  | RightClickMessage
...
export type ApplicationHostMessage = HostStateMessage | PingMessage | PongMessage;
